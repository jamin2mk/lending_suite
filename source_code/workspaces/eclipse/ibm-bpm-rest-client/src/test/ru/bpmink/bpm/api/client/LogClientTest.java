...
//		String csrfToken = auth.getCsrfToken();
		...
		LogClientTest client = new LogClientTest();
...
//		String searchInstances = client.searchInstances(hCsrfToken, qModifiedAfter, qModifiedBefore, qProjectFilter);
		...
		String instanceDetail = client.getInstanceDetail(hCsrfToken, pPiid, qSystemId);
		try {
			client.closeClient();
		} catch (IOException e) {
    ...
    public String searchInstances(String hCsrfToken, String qModifiedAfter, String qModifiedBefore, String qProjectFilter) {
    	String entity = bpmClient.getLogClient().getInstances(hCsrfToken, qModifiedAfter, qModifiedBefore, qProjectFilter);
    	logger.info(entity);
    	return entity;
    }
    
    public String getInstanceDetail(String hCsrfToken, String pPiid, String qSystemId) {
    	String entity = bpmClient.getLogClient().getInstanceDetail(hCsrfToken, pPiid, qSystemId);
    	logger.info(entity);
    	return entity;
    }
}
