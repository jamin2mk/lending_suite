...
public enum InteractionFilter {
    ...
    /**
     * Work on tasks, same as {@literal WORK_ON}.
     */
    WORK_ON_ACTIVE,
    ...
    /**
     * Assess and work on tasks. This implies the retrieval of tasks as implied by the {@literal WORK_ON}
     * or the {@literal ASSESS_AVAILABLE} filter values.
     */
    ASSESS_AND_WORK_ON,
    ...
    /**
     * Browse all tasks. This implies the retrieval of to-do, collaboration and invocation tasks
     * for which the current user is allowed to see.
     */
    BROWSE_ALL
